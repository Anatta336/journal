...
describe('EditorToolbar', () => {
    it('renders all toolbar buttons', async () => {
        ...
        expect(wrapper.find('[data-testid="toolbar-code"]').exists()).toBe(true)
        expect(wrapper.find('[data-testid="toolbar-code-block"]').exists()).toBe(true)
        expect(wrapper.find('[data-testid="toolbar-bullet-list"]').exists()).toBe(true)
    })
})
