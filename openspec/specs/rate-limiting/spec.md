...
Per-IP rate limiting for all backend API endpoints. Protects the login endpoint from brute-force attacks and provides a general baseline against API abuse.
